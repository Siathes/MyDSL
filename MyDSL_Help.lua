...
MyDSL.Help.modules = {
  ...
  { key = "live", title = "Live", category = "Vitals & Combat", window = "MyDSL_Live",
    ...
    commands = {
      ...
      { cmd = "mydsl live title <text>", desc = "Set the window's title text.", example = "mydsl live title Kien" },
  ...
  { key = "portrait", title = "Portrait", category = "Display & Reference", window = "MyDSL_Portrait",
    ...
    commands = {
      ...
      { cmd = "mydsl portrait name <charname>", desc = "Load a specific character's portrait.", example = "mydsl portrait name Kien" },
