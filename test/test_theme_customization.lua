...
local function resetTheme()
  ...
  for i = #MyDSL.Theme.presetOrder, 1, -1 do
    if not table.contains({ "refined_convergence", "terminal_purist", "zoned_hud", "obsidian_ember", "arcane_midnight", "tron_blue", "muted_scroll_nature", "library", "pink_pastel", "rainbow" }, MyDSL.Theme.presetOrder[i]) then
